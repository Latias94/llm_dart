...
final class _ProviderPromptValidator {
  ...
  void _validateUserMessage(int messageIndex) {
    ...
    _requireNoPendingBeforeNextConversationMessage(
      messageIndex,
      'user message',
    );
  }
    ...
    for (var partIndex = 0; partIndex < parts.length; partIndex++) {
      ...
      switch (part) {
        ...
        case ToolApprovalRequestPromptPart():
          _recordApprovalRequest(
            part,
            messageIndex: messageIndex,
            partIndex: partIndex,
          );
        case ToolResultPromptPart():
          _validateAssistantToolResult(
            part,
            messageIndex: messageIndex,
            partIndex: partIndex,
          );
  ...
  void _validateAssistantToolResult(
  ...
  void _requireNoPendingBeforeNextConversationMessage(
    int messageIndex,
