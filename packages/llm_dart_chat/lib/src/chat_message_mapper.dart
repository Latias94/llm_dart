...
/// Convenience mapper from [ChatUiMessage] into common Flutter-facing summaries.
///
/// This does not create another message model.
/// It only projects stable, high-frequency render fields out of `parts` and
