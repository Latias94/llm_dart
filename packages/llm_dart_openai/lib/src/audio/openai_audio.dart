...
class OpenAIAudio extends BaseAudioCapability {
  ...
  // Local OpenAI audio defaults to avoid depending on the main package.
  static const String _defaultTTSModel = 'tts-1';
  ...
  Future<TTSResponse> textToSpeech(
    ...
    final requestBody = <String, dynamic>{
      'model': request.model ?? _defaultTTSModel,
      'input': request.text,
  ...
  Future<STTResponse> speechToText(
    ...
    formData.fields.add(MapEntry('model', request.model ?? _defaultSTTModel));
