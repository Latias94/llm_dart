  ...
  Iterable<TextStreamEvent> decodeStreamChunk(
    ...
    switch (chunkType) {
      ...
      case 'response.reasoning_summary_part.added':
        yield* _handleReasoningSummaryPartAddedChunk(chunk, state, metadata);
        return;
      case 'response.reasoning_summary_text.delta':
        yield* _handleReasoningSummaryTextDeltaChunk(chunk, state, metadata);
        return;
      case 'response.reasoning_summary_part.done':
        yield* _handleReasoningSummaryPartDoneChunk(chunk, state, metadata);
        return;
      case 'response.function_call_arguments.delta':
        yield* _handleFunctionCallArgumentsDeltaChunk(chunk, state, metadata);
        return;
      ...
      case 'response.failed':
        yield* _handleTerminalResponseChunk(chunkType, chunk, state, metadata);
        return;
      case 'error':
