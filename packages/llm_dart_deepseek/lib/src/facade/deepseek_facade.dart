...
///
/// Mirrors the core fields from `DeepSeekProviderSettings` in the Vercel AI SDK
...
///
/// Provides a model-centric API similar to `createDeepSeek` in the Vercel AI SDK.
/// It returns [LanguageModel] instances that can be passed into helpers like
/// [generateTextWithModel] or [runAgentPromptText].
class DeepSeek implements LanguageModelProviderFactory {
  ...
  LanguageModel chat(String modelId) {
    ...
    final config = DeepSeekConfig.fromLLMConfig(llmConfig);
