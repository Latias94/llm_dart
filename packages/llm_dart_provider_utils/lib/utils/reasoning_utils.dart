...
class ReasoningUtils {
  ...
  static Map<String, dynamic> getReasoningEffortParams({
    ...
    // Note: Groq supports `reasoning_effort` on some reasoning models, but the
    // accepted values differ from OpenAI (e.g. `default`, `none`). For Groq, a
    // raw string mapping via provider options may be required.
