...
/// Helper to register the Phind provider factory with the global registry.
void registerPhindProvider() {
  LLMProviderRegistry.registerOrReplace(PhindProviderFactory());
}
