...
///
/// This factory can create providers for any service that offers an
/// OpenAI-compatible API, using pre-configured settings for popular
/// providers like DeepSeek, Gemini, xAI, Groq, etc.
class OpenAICompatibleProviderFactory
  ...
  LLMConfig getDefaultConfig() =>
      LLMConfig(baseUrl: _config.defaultBaseUrl, model: _config.defaultModel);
