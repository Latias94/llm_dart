...
void main() {
  group('LLM Dart Library Entry Point', () {
    test('exports short factories plus the optional AI namespace', () {
      final model = openai(apiKey: 'test-key').chatModel('gpt-5-mini');
      final groupedModel =
      ...
      expect(groupedModel.modelId, model.modelId);
