...
void main() {
  group('Google v3 parts goldens (contract fixtures)', () {
    Future<void> runFixtureGolden(
      String baseName, {
      String provider = 'google',
    }) async {
      final fixturePath = 'test/fixtures/google/chat/$baseName.chunks.txt';
    ...
    final metaDir = Directory('test/fixtures/v3_parts/google');
