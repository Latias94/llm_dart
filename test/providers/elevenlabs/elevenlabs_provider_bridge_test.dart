...
void main() {
  group('ElevenLabsProvider bridge delegation', () {
    test(
      'textToSpeech delegates shared requests to the ElevenLabs package speech model',
      () async {
    ...
    test(
      'speechToText with audio bytes delegates to the ElevenLabs package model',
      () async {
        RequestOptions? capturedOptions;
        Object? capturedBody;
        final dio = _buildResolvedDio((options) {
        ...
        final response = await provider.speechToText(
          const STTRequest(
            ...
            providerOptions: modern_elevenlabs.ElevenLabsTranscriptionOptions(
              languageCode: 'en',
              fileFormat: modern_elevenlabs
                  .ElevenLabsTranscriptionFileFormat.pcmS16le16,
