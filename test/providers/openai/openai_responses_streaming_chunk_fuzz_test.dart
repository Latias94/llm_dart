...
Stream<String> _splitRandom(Stream<String> input,
    {required int seed, int maxLen = 11}) async* {
...
void main() {
  group('OpenAI Responses streaming fuzz (chunk boundaries)', () {
    Future<void> runFixtureFuzz(String baseName,
        {required List<int> seeds}) async {
