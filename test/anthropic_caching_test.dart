...
void main() {
  group('Anthropic Global Cache Tests', () {
    test('System message with global 1-hour cache', () {
      ...
      expect(systemMessage.content, contains('You are a helpful AI assistant.'));
      expect(systemMessage.content, contains('Here is additional context'));
      
      // Should have cache flag in extensions
      final anthropicData = systemMessage.getExtension<Map<String, dynamic>>('anthropic');
    ...
    test('User message with global 5-minute cache', () {
      ...
      // Verify 5-minute TTL
      final anthropicData = userMessage.getExtension<Map<String, dynamic>>('anthropic');
      final contentBlocks = anthropicData!['contentBlocks'] as List<dynamic>;
      final cacheFlag = contentBlocks.first as Map<String, dynamic>;
      final cacheControl = cacheFlag['cache_control'] as Map<String, dynamic>;
    ...
    test('Message without cache should have no extensions', () {
      ...
      expect(regularMessage.content, equals('Regular system message\nMore regular content'));
    ...
    test('API conversion with global cache', () {
      ...
      if (anthropicData != null) {
        ...
        if (message.content.isNotEmpty) {
          final textBlock = <String, dynamic>{'type': 'text', 'text': message.content};
    ...
    test('Multiple messages with different cache settings', () {
      // Message 1: No cache
      final msg1 = MessageBuilder.user()
      ...
      final msg2Cache = (msg2Blocks.first as Map<String, dynamic>)['cache_control'] as Map<String, dynamic>;
      ...
      final msg3Cache = (msg3Blocks.first as Map<String, dynamic>)['cache_control'] as Map<String, dynamic>;
