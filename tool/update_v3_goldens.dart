...
_MetaStatus _ensureMeta({
  ...
  source['notes'] = isVendored
      ? 'Generated by tool/update_v3_goldens.dart by replaying the vendored '
          '.chunks.txt fixture via fake clients and encoding canonical v3 parts '
          'as JSONL.'
      : 'Generated by tool/update_v3_goldens.dart by replaying a handcrafted '
          'contract fixture (no upstream .chunks.txt) via fake clients and '
          'encoding canonical v3 parts as JSONL.';
  meta['source'] = source;

  if (!isVendored) {
    meta.remove('upstream');
  } else {
