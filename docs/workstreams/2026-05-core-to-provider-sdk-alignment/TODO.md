...
- [x] Complete OpenAI-compatible provider family parity row
- [x] Identify provider-specific gaps that should stay provider-owned
- [x] Identify shared option gaps that belong in core contracts
