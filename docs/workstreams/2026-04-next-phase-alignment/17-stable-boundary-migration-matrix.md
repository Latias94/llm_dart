...
| OpenAI remote file lifecycle | focused OpenAI compatibility surface | Remote persistence, purpose fields, and later retrieval semantics are provider-owned and still lack a narrow modern client |
