...
| `HttpConfig`, `ImageConfig`, `ProviderConfig` | Frozen compatibility host | Keep tied to the builder decision | Same window as any future builder removal | Builder posture unresolved |
