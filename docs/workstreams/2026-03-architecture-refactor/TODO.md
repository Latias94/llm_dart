...
- [ ] Decide whether deprecated root OpenAI-compatible preset helpers should gain profile-specific modern bridges, or remain fallback-only while migration keeps moving toward provider-owned packages
