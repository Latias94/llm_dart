...
- [34-legacy-api-removal-window.md](34-legacy-api-removal-window.md)
  - Frozen removal window for the old root-package compatibility APIs, keeping
    routine maintenance releases removal-free and deferring actual removals to
    an explicit breaking prerelease/stable window.
...
- [65-openai-responses-reasoning-compatibility.md](65-openai-responses-reasoning-compatibility.md)
  - Frozen conclusion that OpenAI Responses reasoning-model compatibility also belongs to provider-owned request encoding and shared provider-package capability helpers, not the shared text-generation spec.
- [66-openai-responses-persistence-status.md](66-openai-responses-persistence-status.md)
  - Status note for the implemented OpenAI-owned Responses persistence subset around `store`, `conversation`, `item_reference`, and replay branching.
- [67-openai-native-tool-surface-gap.md](67-openai-native-tool-surface-gap.md)
  - Audit of which remaining OpenAI Responses native-tool families are worth exposing as provider-owned Dart surfaces after the persistence subset landed.
- [68-openai-image-generation-native-tool.md](68-openai-image-generation-native-tool.md)
  - Status note for the first landed OpenAI native-tool declaration slice around `image_generation`.
- [69-openai-mcp-native-tool-surface.md](69-openai-mcp-native-tool-surface.md)
  - Status note for the landed OpenAI `mcp` declaration surface, existing continuation boundary, and the remaining provider-owned output/helper gap.
- [70-openai-output-projection-helpers.md](70-openai-output-projection-helpers.md)
...
- [112-openai-and-google-nontext-result-adoption.md](112-openai-and-google-nontext-result-adoption.md)
  - Status note for extending the richer shared non-text result contract to the
    ...
    surface.
- [113-google-transcription-boundary.md](113-google-transcription-boundary.md)
  - Frozen conclusion that Google should not gain a shared
...
- [179-google-audio-understanding-helper-boundary.md](179-google-audio-understanding-helper-boundary.md)
...
- [190-openai-migration-closure-audit.md](190-openai-migration-closure-audit.md)
  - Closure audit concluding that the old broad OpenAI migration umbrella is
...
- [192-streamed-runner-step-metadata-policy.md](192-streamed-runner-step-metadata-policy.md)
...
- [196-long-tail-openai-compatible-closure-audit.md](196-long-tail-openai-compatible-closure-audit.md)
...
- [203-openai-compat-client-thinning.md](203-openai-compat-client-thinning.md)
...
- [205-openai-chat-facade-thinning.md](205-openai-chat-facade-thinning.md)
  - Status note for splitting the OpenAI chat-completions compatibility host
    ...
    helpers while keeping the stable public import path unchanged.
- [206-openai-audio-facade-thinning.md](206-openai-audio-facade-thinning.md)
...
- provider-facing Dio strategy/factory abstractions now also live in
  `llm_dart_transport`, so provider clients no longer depend on a root-local
...
- OpenRouter/xAI/Phind are now also explicitly *not* symmetry targets: the
  current audited subsets are enough, and any broader expansion now waits for
  stronger provider-specific contract evidence instead of more family-level
  bridge broadening
...
- the next remaining shared-helper blocker for community-provider migration is
  ...
  Dio override probing, or Ollama's earlier `HttpResponseHandler` dependency;
  it is the remaining compatibility builder/factory shell, root error
  ownership, and the capability/message/audio compatibility surfaces
