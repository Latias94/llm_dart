...
- chat-completions request encoding now also covers user `FilePromptPart` mapping for image, audio, and PDF inputs in the migrated OpenAI-family path, while OpenAI compatibility routing still remains intentionally Responses-first
