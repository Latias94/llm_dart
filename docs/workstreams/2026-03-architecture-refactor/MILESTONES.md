...
- the next structural cleanup step is now also clearer: the remaining blocker is no longer cancellation or provider-facing Dio setup, but compatibility-shaped config/default ownership plus `HttpResponseHandler` error mapping
