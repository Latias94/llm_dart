...
Shared `OutputSpec` examples for object, array, choice, and streamed output result surfaces.
...
- **Structured Output**: Shared `generateOutput(...)` and `streamOutputResult(...)` with `OutputSpec`
