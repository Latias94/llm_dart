...
dart run 06_mcp_integration/stdio_examples/server.dart  # Terminal 1
dart run 06_mcp_integration/stdio_examples/llm_client.dart  # Terminal 2

# Test HTTP integration
dart run 06_mcp_integration/http_examples/server.dart  # Terminal 1
dart run 06_mcp_integration/http_examples/llm_client.dart  # Terminal 2
```
