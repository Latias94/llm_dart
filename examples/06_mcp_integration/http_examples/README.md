...
cd examples
dart pub get
dart run 06_mcp_integration/http_examples/server.dart
```
...
```bash
dart run 06_mcp_integration/http_examples/client.dart
```
...
dart run 06_mcp_integration/http_examples/llm_client.dart
```
...
dart run 06_mcp_integration/http_examples/simple_stream_client.dart
```
